...
<body>
    <s:if test="%{# session.opcao_menu == 'artista' }">
        <s:form method="post">
    ...
    <s:elseif test="%{# session.opcao_menu == 'album' }">
        <s:form method="post">
    ...
    <s:elseif test="%{# session.opcao_menu == 'musica' || session.editor==true}">
        <s:form method="post">
            ...
            <s:submit type="button" value="true" name="criar_playlist" label="Criar Playlist" formaction="album"/><br>
            <s:submit type="button" value="true" name="ver_playlist" label="Ver Playlist" formaction="album"/><br>
            <s:submit type="button" value="true" name="editar_playlist" label="Editar PLaylist" fomraction="album"/><br>
            <s:submit type="button" value="true" name="voltar" label="VOLTAR" formaction="menu"/><br>
        </s:form>
    </s:elseif>
    <s:else>
