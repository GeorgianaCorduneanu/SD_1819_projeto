...
public interface RMIServerInterface extends Remote {
	...
	String getListaPessoasCriticaram(String nomeAlbum) throws RemoteException;

	String getPontuacaoMedia(String nomeAlbum) throws RemoteException;

	String criticarAlbum(String nomeAlbum, String critica, String pontuacao, String username) throws RemoteException;
}
